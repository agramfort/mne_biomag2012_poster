...
\mybox[width=0.64\linewidth, opacity=0., color=white]{%
    ...
    {\small\tt mne\_analysis@nmr.mgh.harvard.edu}
...
\begin{minipage}[B]{0.47\linewidth}
    \begin{myexampleblock}{Features}
        ...
        \mydot Review raw data, filter, correct ECG / EOG with SSPs\\
    ...
    \begin{myalertblock}{Project vision \& Goals}
        \mydot State of the art with many examples\\
        \mydot Documented, tested, and easy to use\\
        \mydot Open development, collaboration between different labs\\
...
\begin{minipage}{\linewidth}
    \center
    Funded by: NIH P41RR14075, R01EB009048, NSF 0958669
\end{minipage}
