...
\begin{minipage}{.5\linewidth}
    ...
    \mydot Dipole fitting, RAP-MUSIC, interpolation of bad EEG/MEG channel, automated covariance regularization, multi-taper time-frequency, deep structures in source spaces, basic ECoG support\\
    ...
    \begin{minipage}[t]{0.48\linewidth}
        ...
        \begin{myalertblock}{Learn more}
            \begin{minipage}{1.\linewidth}
                ...
                \mydot http://martinos.org/mne/auto\_examples/ (> 110 demos)\\
            \end{minipage}
        \end{myalertblock}
    \end{minipage}
