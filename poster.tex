...
\begin{minipage}[B]{0.47\linewidth}
    ...
    \begin{myexampleblock}{Software Features}
        ...
        \mydot Review raw data, filter, dampen ECG/EOG with SSPs, ICA\\
        \subsection{Forward \& inverse modeling}
        \mydot Automatic forward modeling with FreeSurfer\\
...
\begin{minipage}{.5\linewidth}
    ...
    \mydot TF Beamformers, IO (BDF/EDF, EGI, etc.), field maps, realtime,
    source spaces + forward in Python, decoding/MVPA, GUIs\\
