...
\begin{minipage}{.5\linewidth}
    ...
    \mydot Dipole fitting, RAP-MUSIC, bad EEG/MEG channel interpolation, automated covariance regularization, multi-taper time-frequency, deep structures source spaces, basic ECOG support\\
